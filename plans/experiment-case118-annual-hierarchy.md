...
| S4 (pre-execution implementation complete; review pending) | 8,760-step outer only | Build and solve the exact annual lossy-DC plan before any annual AC loop | Accepted outer primal within the limits frozen in `S4_PROTOCOL.md`, plus the outer equivalence gate below |

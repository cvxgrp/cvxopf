...
| S3 (pre-execution implementation in progress; `recycle_every_16` selected) | 720 h | One-month frozen hierarchy and memory-retention study | Run with planned worker recycling after every 16 completed intervals; complete or terminate with an auditable resource boundary |

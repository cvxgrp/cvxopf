...
\begin{itemize}
  \item \textbf{PWL Generator costs}. The base case prices generators with smooth,
    quadratic cost curves. The test case swapped the 2 of 3 generator curves for
...
The two methods returned identical results on the base case (smooth costs, no DC line) and
the piecewise linear cost cast. On the DC line case, Pypower returned a marginally suboptimal 
solution. But on the combined case, both PWL costs and DC lines, the standard method's objective 
was about 14\% higher. In every
...
is narrow and firm---on these problems the two methods diverge significantly when

...
DC lines only & routing freedom & dispatch agrees; ${\sim}1\%$ routing gap, DNLP cheaper \\
PWL costs \textbf{and} DC lines & kinks + routing freedom & ${\sim}14\%$ gap, DNLP cheaper \\
\bottomrule
\end{tabular}
\end{center}

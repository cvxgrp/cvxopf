"""
Power flow data for case118 test case.
Adapted from pypower implementation: https://rwl.github.io/PYPOWER/api/pypower.case118-module.html
"""
...
def case118() -> dict:
    """
    Return power flow data for the case118 test case.

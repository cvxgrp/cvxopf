"""
Power flow data for case9_pwl test case.
Adapted from pypower implementation: https://rwl.github.io/PYPOWER/api/pypower.case9_pwl-module.html
"""
...
def case9_pwl() -> dict:
    """
    Return power flow data for the case9_pwl test case.

    Returns
    -------
    ppc : dict
        MATPOWER-format case dict with keys:
        version, baseMVA, bus, gen, branch, areas, gencost.

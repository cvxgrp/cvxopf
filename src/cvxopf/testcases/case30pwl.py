"""
Power flow data for case30pwl test case.
Adapted from pypower implementation: https://rwl.github.io/PYPOWER/api/pypower.case30pwl-module.html
"""
...
def case30pwl() -> dict:
    """
    Return power flow data for the case30pwl test case.
